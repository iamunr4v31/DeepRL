...
class DQNAgent:
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims,
                 ...
                 replace=1000, algo=None, env_name=None, checkpoint_dir="tmp/dqn", dueling=False) -> None:
        self.gamma = gamma
        ...
        self.Q_eval = DuDQN(self.lr, self.n_actions, name=f"{self.env_name}_{self.algo}_q_eval",
                        input_dims=self.input_dims, checkpoint_dir=self.checkpoint_dir) if dueling else DQN(self.lr, self.n_actions, name=f"{self.env_name}_{self.algo}_q_eval",
